                        ...
                        <form action="{{url('update', $student->id)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <label class="custom-control custom-radio">
                                    <input name="gender" type="radio" class="custom-control-input" value="Female" @if($student->gender == "Female") checked @endif>
                                    <span class="custom-control-label">Female</span>
                                </label>
                                <label class="custom-control custom-radio">
                                    <input name="gender" type="radio" class="custom-control-input" value="Male" @if($student->gender == "Male") checked @endif>
