...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-sm-4">
            <a href="{{url('addclass')}}" class="btn btn-primary">Input</a>
        </br>
        </div>
    </div>
    <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <form action="{{url('delete', $row->id)}}" method="post">
                                    ...
                                    @method('DELETE')
                                <a href="{{url('editclass/'.$row->id)}}" ><button class="btn btn-outline-primary" type="button">Ubah</button></a>
                                <button href="{{url('deleteclass/'.$row->id)}}" class="btn btn-outline-danger" type="submit">Hapus</button>
